      ...
      <div class="mt-6 flex flex-wrap flex-col md:flex-row lg:flex-row">
        <div class="md:w-1/2 lg:w-1/2 mb-4 transition duration-300 ease-linear bg-transparent hover:text-indigo-500 text-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 flex items-center relative">
          ...
          <a title="Taiteilijan {stamp.taiteilija} koostesivu" href="/taiteilijat/{handleize(stamp.taiteilija)}" class="ml-4">
            <span class="text-gray-300 text-xs uppercase tracking-wide block">Taiteilija</span>
        ...
        <div class="md:w-1/2 lg:w-1/2 mb-4 transition duration-300 ease-linear bg-transparent hover:text-indigo-500 text-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100 flex items-center relative">
          ...
          <a title="Painopaikan {stamp.painopaikka} koostesivu" href="/painopaikat/{handleize(stamp.painopaikka)}" class="ml-4">
            <span class="text-gray-300 text-xs uppercase tracking-wide block">Painopaikka</span>
